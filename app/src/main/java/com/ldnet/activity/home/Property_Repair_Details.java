 ...
 */
public class Property_Repair_Details extends BaseActionBarActivity {

    private ImageButton btn_back;
    private TextView tv_main_title, btn_score, tv_property_details_no;
    ...
    public void findView() {
        ...
        gv_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                num = position;
                popupWindows = new PopupWindows(Property_Repair_Details.this, view, mDatas1);
            }
        });
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_back) {
            ...
            ScoreDialog();
//            Intent intent = new Intent(Property_Repair_Details.this, Property_Score.class);
...
//            overridePendingTransition(R.anim.slide_in_from_left, R.anim.slide_out_to_right);
    ...
    //报修&投诉沟通信息
    public void RCCommunicate(final String id) {
        // 请求的URL
                        ...
                        try {
                            ...
                            if (json.getBoolean("Status")) {
                                if (jsonObject.getBoolean("Valid")) {
                                    ...
                                    adapter = new TimeAdapter(Property_Repair_Details.this, mTemp);
...
//                    R.anim.slide_in_from_left));
            ...
            iv_show.setAdapter(new MyAdapter(Property_Repair_Details.this,
                    TimeBean));
