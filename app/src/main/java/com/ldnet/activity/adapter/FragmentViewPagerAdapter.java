...
public class FragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    //构造函数
    public FragmentViewPagerAdapter(FragmentManager nfragmentManager, ViewPager nviewPager, List<Fragment> nfragments) {
    ...
    public void onPageScrolled(int i, float v, int i1) {
        if (null != onExtraPageChangeListener) { // 如果设置了额外功能接口
            onExtraPageChangeListener.onExtraPageScrolled(i, v, i1);
        }
    }
