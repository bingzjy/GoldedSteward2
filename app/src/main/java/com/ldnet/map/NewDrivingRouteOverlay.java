 ...
 * 导航路线图层类。
 */
public class NewDrivingRouteOverlay extends MyRouteOverlay{
     ...
     */
    public NewDrivingRouteOverlay(Context context, AMap amap, DrivePath path,
