...
public class RefreshableView extends LinearLayout {
    ...
    private void init() {
        ...
        //刷新bar
        bar = (ProgressBar) refreshView.findViewById(R.id.progress1);
        //下拉显示text
        ...
        rl_refresh = (RelativeLayout)  refreshView.findViewById(R.id.rl_refresh);
        LayoutParams lp = new LayoutParams(LayoutParams.WRAP_CONTENT, -refreshTargetTop);
