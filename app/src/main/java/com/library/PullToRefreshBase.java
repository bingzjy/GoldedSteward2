...
import com.library.internal.FlipLoadingLayout;
import com.library.internal.RotateLoadingLayout;
import com.library.internal.Utils;
import com.library.internal.ViewCompat;
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mStartTime == -1) {
				...
				/**
				 * We do do all calculations in long to reduce software xuanfu
